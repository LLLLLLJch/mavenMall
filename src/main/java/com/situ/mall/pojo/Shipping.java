...
public class Shipping implements Serializable{
	...
	public Shipping(Integer id, Integer user_id, String receiver_name, String receiver_phone, String receiver_mobile,
			...
			Integer receiver_zip, Date create_time, Date update_time) {
		super();
		this.id = id;
	...
	public Integer getReceiver_zip() {
		return receiver_zip;
	}
	public void setReceiver_zip(Integer receiver_zip) {
		this.receiver_zip = receiver_zip;
	}
