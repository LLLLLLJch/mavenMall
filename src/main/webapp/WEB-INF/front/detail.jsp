...
<html>
	...
	<head>
		<meta charset="UTF-8">
		<title>华为畅享6S</title>
		<link rel="stylesheet" type="text/css" href="${ctx}/resources/css/detail_style.css" />
		...
		<script type="text/javascript">
			...
			function addCart(){
				...
				if(username != null && username != ""){
					var quantity = $("#num").val();
					 $.post(
						"${ctx}/getDetailPage/getDetailHaveUserName.shtml",
						{
						...
						window.location.href="${ctx}/getDetailPage/getDetailNoUserName.shtml?productId="+product_id+"&quantity="+quantity;
				 } 
			}
			...
			function goCart(){
				...
				if(username != null && username != ""){
					var quantity = $("#num").val();
					 $.post(
						"${ctx}/getDetailPage/getDetail.shtml",
						{
	...
	<body>
			...
			<div class="top_center">
				...
				<div class="right">
					<ul>
						...
						<li>
							<a class="indent" href="javascript:gotoUserOrder();">我的订单</a>
						</li>
						<li>
		...
		<div class="logo_center">
			<div class="left">
				<a href="${ctx}/index.shtml"/><img src="${ctx}/resources/img/LOGO.png" />
			</div>
			<div class="center">
			...
			<div class="little_menu">
				<ul>
					...
					<li class="little_menu_right">
						华为官方旗舰店
						<img src="${ctx}/resources/img/tou.png" /> 联系供应商
					</li>
					<li class="little_menu_bottom">
						<img src="${ctx}/resources/img/shoucang2.png" /> 联系供应商
					</li>
				</ul>
			</div>
		</div>
					...
					<li class="banner_center_left_center">
						<ul>
							<li class="left_right_nav">
								<img src="${ctx}/resources/img/left.png" />
							</li>
							...
							<li class="left_right_nav">
								<img src="${ctx}/resources/img/right.png" />
							</li>
						</ul>
					</li>
					<li class="banner_center_left_bottom">
						<img src="${ctx}/resources/img/xin.png" />&nbsp;关注&nbsp;&nbsp;
						<img src="${ctx}/resources/img/enjoy.png" />&nbsp;分享&nbsp;&nbsp;
						<img src="${ctx}/resources/img/duizhao.png" />&nbsp;对比
					</li>
				</ul>
			</div>
			<div class="right">
				...
				<ul>
					...
					<li class="right_2">
						<ul>
							<li class="right_2_1">
								<img class="img_117" src="${ctx}/resources/img/117.png" />
							...
							<li class="right_2_2">
								...
								<img src="${ctx}/resources/img/120.png" />
							</li>
							<li class="right_2_3">
							...
							<li class="right_2_4">
								...
								<img src="${ctx}/resources/img/119.png" />&nbsp;&nbsp;
								<img src="${ctx}/resources/img/118.png" />
							</li>
							<li class="right_2_5">
							...
							<li class="right_2_6">
								...
								<img src="${ctx}/resources/img/xia.png" />
							</li>
						</ul>
					</li>
					<li class="right_3">
						...
						<ul>
							...
							<li class="safeguard">
								...
								<span class="right_4_8">
									屏碎保1年&nbsp;¥66&nbsp;
									<img src="${ctx}/resources/img/111.png"/>
								</span>
				...
				<ul>
					<li>
						<div class="title_center_img">
							<img src="${ctx}/resources/img/130.png" />
						</div>
					...
					<li>
						<div class="add_img">
							<img src="${ctx}/resources/img/jia.png" />
						</div>
					</li>
					<li>
						<div class="title_center_img">
							<img src="${ctx}/resources/img/131.png" />
						</div>
						<div class="title_center_p">
					...
					<li>
						<div class="title_center_img">
							<img src="${ctx}/resources/img/137.png" />
						</div>
						<div class="title_center_p">
							机灵猫 畅享6S手机壳女防摔带支架保护套
						</div>
					...
					<li>
						<div class="title_center_img">
							<img src="${ctx}/resources/img/132.png" />
						</div>
						<div class="title_center_p">
					...
					<li>
						<div class="title_center_img">
							<img src="${ctx}/resources/img/133.png" />
						</div>
						<div class="title_center_p">
							品胜 iPad充电器 移动电源充电
						</div>
					...
					<li>
						<div class="title_center_img">
							<img src="${ctx}/resources/img/134.png" />
						</div>
						<div class="title_center_p">
					...
					<li>
						<div class="nav_img">
							<img src="${ctx}/resources/img/135.png" />
						</div>
					</li>
					<li>
						<div class="eq_img">
							<img src="${ctx}/resources/img/136.png" />
						</div>
					</li>
					<li>
						<div class="add_all">
			...
			<div class="right">
				<ul>
					...
					<li class="de_li_2">
						...
						<span class="care1">
								<img src="${ctx}/resources/img/xin.png"/>
								关注
							</span>
						</span>
					</li>
		...
		<div class="surper_big">
			...
			<div class="left">
				<div class="left">
					...
					<ul>
						<li>
							<img src="${ctx}/resources/img/138.png" />
						...
						<li>
							<img src="${ctx}/resources/img/139.png" />
						...
						<li>
							<img src="${ctx}/resources/img/140.png" />
						...
						<li>
							<img src="${ctx}/resources/img/141.png" />
						...
						<li>
							<img src="${ctx}/resources/img/142.png" />
						...
						<li>
							<img src="${ctx}/resources/img/143.png" />
						...
						<li>
							<img src="${ctx}/resources/img/144.png" />
						...
						<li>
							<img src="${ctx}/resources/img/145.png" />
			...
			<div class="ranking">
				...
				<div class="bottom">
					<ul>
						<li class="ranking_1">
							<img class="brand_ranking" src="${ctx}/resources/img/yuan1.png"/>
