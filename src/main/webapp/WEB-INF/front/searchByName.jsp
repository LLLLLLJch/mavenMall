			...
			<ul class="message-l">
				<div class="topMessage">
					<div class="menu-hd">
						...
						<li><a class="login" href="${ctx}/getLogin/goLogin.shtml" target="_blank">请登录</a></li>
						<li><a href="register.html" target="_blank">快速注册</a></li>
					</c:if>
					<c:if test="${not empty username }">
						<li><a class="login" href="${ctx}/getLogin/goLogin.shtml" target="_blank">欢迎 : ${username }</a></li>
									...
									<c:forEach items="${pageBean.list}" var="product">
										<li>
											<div class="i-pic limit">
												<a href="${ctx}/detail.shtml?id=${product.id}"><img src="${product.fullUrl}" /></a>											
