...
<title>付款成功页面</title>
<link rel="stylesheet"  type="text/css" href="${ctx}/resources/css/amazeui.css"/>
...
<div class="am-container header">
  <ul class="message-l">
    <div class="topMessage">
     <div class="menu-hd">
       <a href="#" target="_top" class="h">欢迎您，${username}</a>
       <a href="javascript:goexist();" target="_top">注销</a>
     </div></div>
  </ul>
  <ul class="message-r">
    <div class="topMessage home"><div class="menu-hd"><a href="${ctx}/index.shtml" target="_top" class="h">商城首页</a></div></div>
...
<div class="take-delivery">
 <div class="status">
   ...
   <div class="successInfo">
     <ul>
       <li>付款金额<em>¥${orderItem.total_price}</em></li>
       <div class="user-info">
         <p>收货人：${shipping.receiver_name}</p>
         <p>联系电话：${shipping.receiver_phone}</p>
     ...
     <div class="option">
       <span class="info">您可以</span>
        <a href="${ctx}/getOrder/gotoUserOrder.shtml?username=${username}" class="J_MakePoint">查看<span>订单详情</span></a>
     </div>
    </div>
  </div>
</div>
