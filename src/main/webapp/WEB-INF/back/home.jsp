...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		<link href="${ctx}/resources/back/assets/css/bootstrap.min.css" rel="stylesheet" />
        <link rel="stylesheet" href="${ctx}/resources/back/css/style.css"/>
        <link rel="stylesheet" href="${ctx}/resources/back/assets/css/font-awesome.min.css" />
        <link href="${ctx}/resources/back/assets/css/codemirror.css" rel="stylesheet">
		<!--[if IE 7]>
		...
		<![endif]-->
		<script src="${ctx}/resources/back/assets/js/ace-extra.min.js"></script>
		<!--[if lt IE 9]>
		<script src="assets/js/html5shiv.js"></script>
		<script src="assets/js/respond.min.js"></script>
		<![endif]-->
        		<!--[if !IE]> -->
		<script src="${ctx}/resources/back/assets/js/jquery.min.js"></script>        
		<!-- <![endif]-->
           	<script src="${ctx}/resources/back/assets/dist/echarts.js"></script>
        <script src="${ctx}/resources/back/assets/js/bootstrap.min.js"></script>
...
<div class="page-content clearfix">
 ...
 <div class="state-overview clearfix">
                  ...
                  <div class="col-lg-3 col-sm-6">
                      <section class="panel">
                      	<a href="${ctx}/getOrderBack/getUserOrder.action" title="订单详情">
                          <div class="symbol yellow">
                               <i class="icon-shopping-cart"></i>
                          </div>
                          <div class="value">
                              <h1>${orderCount}</h1>
                              <a href="${ctx}/getOrderBack/getUserOrder.action"><p>商城订单</p></a>
                          </div>
                      </section>
                  </div>
                  <div class="col-lg-3 col-sm-6">
